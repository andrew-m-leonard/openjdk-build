...
pipelineJob("${BUILD_FOLDER}/${JOB_NAME}") {
    ...
    parameters {
        ...
        booleanParam('keepTestReportDir', false, 'If set to true the test report dir will not be deleted. Does not apply to JUnit jobs which are always kept, eg.openjdk.')
