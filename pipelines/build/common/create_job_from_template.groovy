    ...
    parameters {
        ...
        textParam('BUILD_CONFIGURATION', "$BUILD_CONFIG", """
            <dl>
                ...
                <dt><strong>KEEP_TEST_REPORTDIR</strong></dt><dd>If set to true the test report dir will not be deleted. Does not apply to JUnit jobs which are always kept, eg.openjdk.</dd>
